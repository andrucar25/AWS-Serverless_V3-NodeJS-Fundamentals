...
import { Get, And } from "json-schema-to-ts/lib/utils";
import { MetaType, Never, Tuple, Error } from "json-schema-to-ts/lib/meta-types";
import { Values as ArrValues } from "json-schema-to-ts/lib/meta-types/array";
import { Values, IsOpen, OpenProps } from "json-schema-to-ts/lib/meta-types/tuple";
...
import { DistributeIntersection } from "json-schema-to-ts/lib/meta-types/intersection/union";
...
export declare type ClearTupleIntersections<T, O = ClearIntersections<OpenProps<T>>> = Tuple<ClearTupleValuesIntersections<A.Cast<Values<T>, L.List>>, O extends Never ? false : IsOpen<T>, O>;
...
declare type IntersectTupleToArray<T, A, V extends L.List = IntersectTupleToArrValues<A.Cast<Values<T>, L.List>, ArrValues<A>>, N = HasNeverValue<V>, O = Intersect<OpenProps<T>, ArrValues<A>>> = N extends true ? Never : Tuple<V, IsOpen<T> extends true ? (O extends Never ? false : true) : false, O>;
